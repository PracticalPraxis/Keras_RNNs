...
#expensieve (approx 10 minutes on a GTX 980m)
...
#Preparing our data print('Loading data...')
...
#additional data from previous loops used in the model
#Additionally, this carried over data is transformed according to certain weights that works to 
...
history = model.fit(input_train, y_train,
					epochs=10,
					batch_size=128,
					#New Parameter here, validation split means that the given fraction of the total data will be used as the validation data
